    ...
    >
      ...
      <header className="flex justify-between items-center px-4 sm:px-10 py-3 bg-white shadow-md">
        ...
        >
          ...
          <div
            className="h-8 w-8 mr-2 rounded-full flex items-center justify-center"
            style={{ backgroundColor: "#42cf17", opacity: 0.3 }}
          >
            🌱
          </div>
        ...
        <button
          className="text-white font-semibold py-2 px-5 rounded-full transition duration-150 shadow-md hover:opacity-90"
      ...
      <main className="flex-grow flex justify-center items-center p-4">
        <div className="bg-white p-8 sm:p-10 rounded-xl shadow-2xl w-full max-w-md text-center">
          ...
          <p className="text-sm text-gray-500 mb-8">Freshness You Can Trust.</p>
