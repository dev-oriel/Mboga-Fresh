    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-6 py-6 mt-12">
        <div className="flex items-center justify-between text-sm text-gray-600">
          <div>
            © {new Date().getFullYear()} Mboga Fresh. All rights reserved.
          </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <label className="block">
                    ...
                    <div
                      ...
                      className="inline-flex items-center gap-2 px-3 py-2 rounded-md border hover:bg-gray-50 cursor-pointer"
                    >
                  ...
                  <div className="text-xs text-gray-500">
                    PNG, JPG, or HEIC. Max 5MB. Images are stored locally for
                    demo purposes.
                  </div>
                </div>
              </div>
              ...
              <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    placeholder="Add a short description to help buyers..."
                    className="w-full rounded-md border px-3 py-2 bg-white dark:bg-gray-900"
                    rows={3}
                  />
                </div>
