...
const VendorCard = ({ id, name, img }) => {
  ...
  return (
    <Link
      ...
      className="text-center min-w-32 border-green-500  "
    >
      <div
        className="w-28 h-28 mx-auto rounded-full bg-cover bg-center mb-2 ring-2 ring-transparent group-hover:ring-emerald-400 transition-all"
