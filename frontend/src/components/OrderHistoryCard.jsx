...
const OrderHistoryCard = () => {
  ...
  const [showAll, setShowAll] = useState(false); // NEW: control order list expansion
  ...
  // Show 2 most recent orders by default, expand on toggle
